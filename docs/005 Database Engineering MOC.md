...
[using non-key attributes, LIKE statements and wildcards]: <using non-key attributes%2C LIKE statements and wildcards> "using non-key attributes, LIKE statements and wildcards"
